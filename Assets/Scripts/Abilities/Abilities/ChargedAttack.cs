...
namespace AF
{
    [CreateAssetMenu(fileName = "Charged Attack Ability", menuName = "Abilities / Weapons / New Charged Attack Ability", order = 0)]
    public class ChargedAttackAbility : Ability
    {
        [Header("FX")]
