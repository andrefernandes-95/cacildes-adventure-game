...
namespace AF
{
    ...
    public class PlayerBackstabController : MonoBehaviour
    {
        ...
        public bool PerformBackstab()
        {
            ...
            if (enemy != null && CanBackstab(enemy, playerManager.GetAttackDamage(enemy)))
            {
                ...
                enemy.characterBaseDamageReceiver.waitingForBackstab = true;

                bool isBackstabbing = false;
                // If backstab sucess
                enemy.characterBaseDamageReceiver.HandleIncomingDamage(playerManager, (incomeDamage) =>
                {
                    isBackstabbing = true;
        ...
        public bool CanBackstab(CharacterManager target, Damage incomingDamage)
        {
            ...
            if (!target.characterBaseDamageReceiver.canBeBackstabbed)
            {
                return false;
            }
            ...
            if (target.characterBaseDamageReceiver.isTakingDamage)
            {
                return false;
            }
